...
import {
  prismaProductsService,
  PrismaProduct,
  ProductStatus,
} from "@/services/prismaProducts";
...
export default function ManualProductForm() {
  ...
  const handleStatusToggle = async (
    ...
    const newStatus: ProductStatus =
      currentStatus === "published" ? "paused" : "published";
        ...
        window.dispatchEvent(
          new CustomEvent("showToast", {
            detail: {
              ...
              message: `Producto ${
                newStatus === "published" ? "publicado" : "pausado"
              } exitosamente`,
            },
          })
        );
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <div className="text-gray-600">
                <span className="font-medium text-[#b8a089]">
                  Haz clic para subir
                </span>{" "}
        ...
        <div className="mb-6">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="bg-red-600 text-white px-3 py-1.5 rounded text-sm hover:bg-red-700 transition-colors flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <svg
            ...
            <button
              ...
              disabled={products.length === 0}
              className="bg-green-600 text-white px-3 py-1.5 rounded text-sm hover:bg-green-700 transition-colors flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <svg
                className="w-3 h-3 mr-1.5"
                fill="none"
